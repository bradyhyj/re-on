        ...
        <div className="flex flex-col h-full w-full bg-[#F8F9FA] text-[#111] overflow-hidden absolute inset-0 z-[200]">
            ...
            <div className="flex items-center justify-between px-4 pt-5 pb-4 bg-white border-b border-[#F0F0F0] shrink-0">
                ...
                <div className="flex flex-col items-center">
                    ...
                    <span className="text-[11px] text-[#999]">Gemini 3.1 Flash Lite 연동 중</span>
                </div>
            ...
            <div ref={scrollRef} className="flex-1 overflow-y-auto px-5 py-6 space-y-6 scroll-smooth">
                ...
                {isTyping && (
                    <div className="flex justify-start items-end gap-2">
                        ...
                        <div className="flex flex-col max-w-[75%]">
                            <span className="text-[11px] text-[#999] ml-1 mb-1 font-medium">다시:ON AI</span>
                            <div className="px-4 py-3 bg-white text-[#111] border border-[#F0F0F0] rounded-[20px] rounded-bl-none shadow-sm flex items-center gap-1.5 h-[46px]">
                                <motion.div className="w-1.5 h-1.5 bg-[#CCC] rounded-full" animate={{ y: [0, -4, 0] }} transition={{ duration: 0.6, repeat: Infinity, delay: 0 }} />
                                <motion.div className="w-1.5 h-1.5 bg-[#CCC] rounded-full" animate={{ y: [0, -4, 0] }} transition={{ duration: 0.6, repeat: Infinity, delay: 0.2 }} />
                                <motion.div className="w-1.5 h-1.5 bg-[#CCC] rounded-full" animate={{ y: [0, -4, 0] }} transition={{ duration: 0.6, repeat: Infinity, delay: 0.4 }} />
                            </div>
                        </div>
                    </div>
                )}
